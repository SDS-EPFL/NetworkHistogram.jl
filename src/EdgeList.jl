...
_fast_compressed_obs(d::Dist, A::AbstractMatrix) = _from_adj_to_edge_list(A, x -> _fast_compressed_obs(d, x))
_fast_compressed_obs(d::Dist, A::EdgeList{E}) where {E} = _make_shift_broadcast(A.data, x -> _fast_compressed_obs(d, x))
