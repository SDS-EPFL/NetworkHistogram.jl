...
function select_swap(node_assignment::Assignment, A, method::RandomNodeSwap)
    ...
    n2 = group_index==node_assignment.number_groups ? node_assignment.group_size[2] : node_assignment.group_size[1]
